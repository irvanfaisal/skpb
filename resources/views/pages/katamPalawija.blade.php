        ...
        <div class="grid grid-cols-1 md:grid-cols-12 flex-grow">
            <div id="map" class="flex-grow col-span-12">
                    ...
                    <div id="menu-layer" class="flex flex-col">
                        <input type="month" id="month" name="month" class="mb-1 p-2 bg-yellow-400 bg-opacity-90 hover:bg-opacity-100" onchange="getKatamPalawija()" style="max-width:130px;">
                        <select id="dasarian" class="mb-1 p-2 bg-yellow-400 bg-opacity-90 hover:bg-opacity-100" onchange="getKatamPalawija()" style="max-width:130px;">
                    ...
                    <div id="map-legend" class="my-auto text-right">
                        <div>
                            <div class="block md:flex">
                                ...
                                <p class="text-black text-xs text-center font-bold py-1 px-2" style="background-color:#fb8072;">Pestisida</p>
        ...
        <div class="border border-teal-500 shadow-lg modal-container bg-white mx-auto rounded shadow-lg z-50 overflow-y-auto">
            <div class="modal-content py-4 text-left px-6">
                ...
                <div class="w-full mx-auto my-4">
                    <p id="modal-title" class="uppercase font-bold my-2">Kalender Tanam Palawija</p>
...
<script type="text/javascript">
    ...
    setTimeout(() => { getKatamPalawija();  }, 250);
    setTimeout(() => { 
    ...
    document.getElementById("menu-katam-palawija").classList.add("bg-yellow-500");
    document.getElementById("menu-katam-palawija").childNodes[1].childNodes[1].classList.remove("text-green");
    document.getElementById("menu-katam-palawija").childNodes[1].childNodes[1].classList.add("text-white");
        ...
        const openModal = (village) => {
            getVillageKatamPalawija(village);
