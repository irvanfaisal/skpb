    ...
    <section id="dashboard-container" class="flex flex-col home-section p-2">
        <div id="dashboard-title" class="bg-green-800 grid grid-cols-1 justify-between mb-2">
            <div class="bg-green-gradient py-1 px-1">
                <h1 class="text-gray-100 md:text-2xl uppercase font-bold"><span id="layer-name">Kerentanan Hama Kabupaten Lombok Tengah</span></h1>
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-12 flex-grow">
            <div id="map" class="flex-grow col-span-12">
                    ...
                    <div id="menu-layer" class="flex flex-col">
                        <input type="month" id="month" name="month" class="mb-1 p-2 bg-yellow-400 bg-opacity-90 hover:bg-opacity-100" onchange="getHama()" style="max-width:130px;">
                        <select id="dasarian" class="mb-1 p-2 bg-yellow-400 bg-opacity-90 hover:bg-opacity-100" onchange="getHama()" style="max-width:130px;">
                    ...
                    <div id="map-legend" class="my-auto text-right">
                        <div>
                            <p class="text-black text-gray-100 uppercase text-center font-bold py-1">Potensi Jumlah Jenis Hama</p>    
                            <div class="block md:flex">
                                <p class="text-black text-xs text-center font-bold py-1 px-2" style="background-color:#80b1d3;">0</p>
                                <p class="text-black text-xs text-center font-bold py-1 px-2" style="background-color:#8dd3c7;">1</p>
                                <p class="text-black text-xs text-center font-bold py-1 px-2" style="background-color:#ffffb3;">2</p>
                                <p class="text-black text-xs text-center font-bold py-1 px-2" style="background-color:#bebada;">3</p>
                                <p class="text-black text-xs text-center font-bold py-1 px-2" style="background-color:#fdb462;">4</p>
                                <p class="text-black text-xs text-center font-bold py-1 px-2" style="background-color:#fb8072;">5</p>
                            </div>
                        </div>
                    </div>
            </div>
                        ...
                        <table id="table-1" class="table-auto text-xs w-full text-gray-100">
                            <thead class="bg-yellow-600 bg-opacity-50 text-gray-100 uppercase">
                                <tr>
                                    ...
                                    <th class="whitespace-nowrap p-1">Jumlah</th>
                                    <th class="whitespace-nowrap p-1">Jenis</th>
                                </tr>
                            </thead>
...
<script type="text/javascript">
    ...
    document.getElementById("menu-hama").classList.add("bg-yellow-500");
    document.getElementById("menu-hama").childNodes[1].childNodes[1].classList.remove("text-green");
    document.getElementById("menu-hama").childNodes[1].childNodes[1].classList.add("text-white");
