    ...
    <section id="dashboard-container" class="flex flex-col home-section p-2">
        <div id="dashboard-title" class="bg-green-800 grid grid-cols-1 justify-between mb-2">
            <div class="bg-green-gradient py-1 px-1">
                <h1 class="text-white md:text-2xl uppercase font-bold"><span id="layer-name">Prediksi Iklim Kabupaten Lombok Tengah</span></h1>
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 flex-grow">
            <div id="map" class="h-full col-span-4 flex-grow z-30">
                    ...
                    <div id="menu-layer" class="flex flex-col gap-2">
                        <div>
                            <select id="layer" class="p-2 shadow-sm bg-yellow-400 rounded-sm bg-opacity-75 border border-gray-900 border-opacity-10 hover:bg-opacity-100" onchange="getIklim()" style="max-width:130px;">
                                <option class="bg-white text-black" selected value="iklim">Prediksi Iklim</option>
                            </select>
                        </div>
                        <div>
                            <input type="month" id="month" name="month" class="px-2 py-1 shadow-sm bg-yellow-400 rounded-sm bg-opacity-75 border border-gray-900 border-opacity-10 hover:bg-opacity-100" onchange="getIklim()" style="max-width:130px;">
                        </div>
                        <div>
                            <select id="dasarian" class="p-2 shadow-sm bg-yellow-400 rounded-sm bg-opacity-75 border border-gray-900 border-opacity-10 hover:bg-opacity-100" onchange="getIklim()" style="max-width:130px;">
            ...
            <div id="summary-container" class="hidden md:flex flex-col flex-nowrap bg-gray-900 shadow-md border border-opacity-20 bg-opacity-50 px-2 pb-2 rounded">
                <div id="summary-tabs" class="mt-2">
                    ...
                    <nav class="tabs flex flex-col sm:flex-row">
                        <button data-target="panel-1" data-tab="tab-climate" class="tab active text-gray-100 bg-green-600 whitespace-nowrap text-xs py-1 px-2 block hover:bg-green-600 hover:bg-opacity-50 focus:outline-none flex-grow border-b border-r">
                            Iklim
                        </button>
                    </nav>
                </div>
                    ...
                    <div class="panel-1 active tab-content h-full">
                        <div class="text-white py-2 bg-opacity-20">
                            <div style="height:50vh;overflow-y:auto;" class="summary-table overflow-y-auto custom-scrollbar pr-1 custom-scroll-vertical">                            
                                <table id="table-1" class="table-auto text-xs w-full">
                                    <thead class="bg-green-800 uppercase text-white">
                                        <tr>
                                            <th class="text-left p-1">Desa</th>
                                            <th class="whitespace-nowrap p-1">Hujan (mm/10 Hari)</th>
                                        </tr>
                                    </thead>
        ...
        <div class="border mx-2 border-teal-500 shadow-lg modal-container bg-white mx-auto rounded shadow-lg z-50 overflow-y-auto">
            <div class="modal-content py-4 text-left px-6">
                ...
                <div class="h-96 w-max custom-scroll-vertical custom-scroll-vertical-red" style="overflow-y:auto;">
                    <div id="chart-1" class="my-auto" style="height:250px;"></div>
                    <div id="chart-2" class="hidden"></div>
                    <div id="chart-3" class="hidden"></div>
                    <div id="chart-4" class="hidden"></div>
                </div>
...
<script type="text/javascript">
    ...
    document.getElementById("menu-iklim").classList.add("bg-yellow-500");
    document.getElementById("menu-iklim").childNodes[1].childNodes[1].classList.remove("text-green");
    document.getElementById("menu-iklim").childNodes[1].childNodes[1].classList.add("text-white");
